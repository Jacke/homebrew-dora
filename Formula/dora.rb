class Dora < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "16bda32e0cbf86a75b85df1113430e3da40d652caec426d43f6b1bb6902434bf"
    end
    on_intel do
      url "https://github.com/Jacke/doradura/releases/download/tui-v0.6.1/dora-x86_64-apple-darwin.tar.gz"
      sha256 "6ac5cd146fd3c1f2171697b4557b02cd4cde0733cce49c697ccfa124dad6bef7"
    end
  end

  on_linux do
    url "https://github.com/Jacke/doradura/releases/download/tui-v0.6.1/dora-x86_64-unknown-linux-gnu.tar.gz"
    sha256 "0202b4531f5ca83f6c384872563363d2a01bed68d216828330238384695fe405"
  end
